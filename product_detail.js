...
<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist" >
    ...
    <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false" style="font-size: 24px;">Contact</button>
  </div>
</nav>
...
<p class="mt-4">
                    ...
                    <div class="product-price-group d-flex row mt-4 ">
                        ...
                        <div class=" col-md-4  text-center" id="img_rolex">
                            <img src="rolex.png" height="100px" width="100px" alt style="border:1px solid">
                        </div>
</div>
