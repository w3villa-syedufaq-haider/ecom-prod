...
for (let i = 0; i < searchResults.length; i++) {
    // Create a new card element for each product
        ...
        <img src=${searchResults[i].img}  onclick="search(event,${searchResults[i].id})"class="card-img-top" width="100%" height="300px">
...
window.onload = () => {
    ...
    showsearch.innerHTML = `
      <div class="card position-relative m-3 " style="width:280px;">
        ...
        <img src=${product.img} onclick="search(event,${product.id})" class="card-img-top" width="100%" height="300px">
        <div class="card-body pt-0 px-0">
          <div class="d-flex flex-row justify-content-between p-3 mid">
            <a class="d-flex flex-column text-muted mb-1">
              ${product.brand}
